...
public class CardListAdapter extends ArrayAdapter<ArrayList> {
    ...
    private final SavedAdhaarCardActivity context;
    private final ArrayList<JSONObject> values;

    public CardListAdapter(SavedAdhaarCardActivity context, ArrayList values){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.activity_card_list_adapter,parent,false);
